...
TIE_DELTA = 0.1
openai.api_key = 'sk-ZblUFrvihTInrXhs52D55b59B16e4fF3Ad381eCbA4E66e80'
...
def run_judge_single(question, answer, judge, ref_answer, multi_turn=False):
    ...
    if model in OPENAI_MODEL_LIST:
        judgment = chat_completion_openai("gpt4o", conv, temperature=0, max_tokens=2048)
...
def chat_completion_openai(model, conv, temperature, max_tokens, api_dict=None):
    # openai.api_key = 'sk-49VAm6uCdWSxb7xQEa64732596644dE8Aa30A58cFc73E146'
    # openai.api_base = 'http://rerverseapi.workergpt.cn/v1'
    openai.api_key = 'sk-ZblUFrvihTInrXhs52D55b59B16e4fF3Ad381eCbA4E66e80'
    openai.api_base = 'https://api.bianxie.ai/v1'
