...
def display_result_single(args):
    if args.input_file is None:
        input_file = (
            ...
            f"data/{args.bench_name}/model_judgment/mistral-7b-alpaca_tips_what_1k_sharegpt_refined-e15lr2e-06_single.jsonl"
            #llama2-13b-cluster_pair_score_myprompt_sharegpt-e15lr1e-05_single
        )
    else:
...
def display_result_pairwise(args):
    if args.input_file is None:
        input_file = (
            ...
            f"data/{args.bench_name}/model_judgment/myprompt_len2048-alpaca52k-less_v3_tie.jsonl"
        )
    else:
        input_file = args.input_file
